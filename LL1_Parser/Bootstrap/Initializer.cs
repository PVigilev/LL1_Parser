...
namespace LL1_Parser.Bootstrap
{
    ...
    static class DefaultInitializer
    {
        ...
        static GrammarCreator CreateDefaultGrammarCreator()
        {
            ...
            grm.RegisterRule("Grammar1", "empty_string".Split(' '), new DelegateRuleExpressionCreator[] { new DelegateRuleExpressionCreator(ReturnGrammarCreator) });
            ...
            grm.RegisterRule("Symbols", "empty_string".Split(' '), new DelegateRuleExpressionCreator[] { new DelegateRuleExpressionCreator(ReturnNewListString) });
            ...
            grm.RegisterRule("Exprs", "empty_string".Split(' '), new DelegateRuleExpressionCreator[] { new DelegateRuleExpressionCreator(ReturnNewListExpr) });
            ...
            grm.RegisterRule("Name1", "empty_string".Split(' '), new DelegateRuleExpressionCreator[] { new DelegateRuleExpressionCreator(ReturnNewListString) });
            ...
            grm.RegisterRule("Args", "empty_string".Split(' '), new DelegateRuleExpressionCreator[] { new DelegateRuleExpressionCreator(ReturnNewListExpr) });
            ...
            grm.RegisterRule("Args1", "empty_string".Split(' '), new DelegateRuleExpressionCreator[] { new DelegateRuleExpressionCreator(ReturnNewListExpr) });
